import Coffee1 from "../assets/coffee-imgs/coffee-1.jpg";
import Coffee2 from "../assets/coffee-imgs/coffee-2.jpg";
import Coffee3 from "../assets/coffee-imgs/coffee-3.jpg";
import Coffee4 from "../assets/coffee-imgs/coffee-4.jpg";
export default [
  {
  ...
  },
  {
    ...
    name: "Wildfire",
    description:
      "A bold and smoky blend with notes of dark chocolate and molasses.",
    price: 12.99,
    region: "Africa",
    weight: 500,
  ...
  },
  {
    ...
    name: "Breezy Beans",
    description:
      "This coffee blend is made from beans sourced from Honduras and Costa Rica. It is a light roast coffee with a bright and citrusy flavor profile. It is perfect for pour-over and drip coffee brewing methods.",
    price: 11.99,
    region: "Central America",
    weight: 500,
  ...
  },
  {
    ...
    description:
      "A light and fruity coffee with notes of blueberry and citrus. Grown in the highlands of Ethiopia, this coffee is sure to brighten up your morning.",
    price: 12.99,
    region: "Africa",
    weight: 500,
    roast_level: 2,
  ...
  },
  {
    ...
    name: "Lazy Days",
    description:
      "A medium-bodied coffee with a sweet and nutty flavor. Grown in the lush regions of Brazil, this coffee is perfect for a lazy afternoon.",
    price: 9.99,
    region: "South America",
    weight: 500,
    roast_level: 3,
  ...
  },
  {
    ...
    name: "Savanna Noir",
    description:
      "A bold and rich coffee from the African savanna, with notes of dark chocolate and blackcurrant.",
    price: 12.99,
    region: "Africa",
    weight: 500,
    roast_level: 4,
  ...
  },
  {
    ...
    name: "Midnight Mocha",
    description:
      "Indulge in the rich, velvety flavors of this decadent mocha blend. Dark chocolate and espresso notes are combined with a touch of vanilla for a luxurious coffee experience.",
    price: 14.99,
    region: "South America",
    weight: 500,
  ...
  },
  {
    ...
    name: "Central Perk",
    description:
      "A medium roast coffee with a smooth, nutty flavor and a hint of caramel. Inspired by your favorite coffee shop!",
    region: "Central America",
    weight: 500,
    roast_level: 3,
  ...
  },
  {
    ...
    name: "Chilean Charm",
    description:
      "This coffee boasts a smooth and balanced flavor, with notes of chocolate, caramel, and a hint of fruit. It has a medium body and a subtle acidity that will leave you feeling refreshed and energized.",
    price: 12.99,
    region: "South America",
    weight: 500,
